...
public abstract class ActionTendencyOperatorFactory {
	...
	public static Step CreateATOperator(AgentModel am, Action at)
	{
		...
		EmotionCondition ec = new EmotionCondition(true,em.getType(),Constants.AGENT_STRING);
		ec.SetIntensity(em.GetPotential());
		
		s = new Step(Constants.AGENT_SYMBOL, at.getName(), 0.9f);
		...
		String eventName = "EVENT(" + Constants.AGENT_STRING + "," + at.getName() + ")";
