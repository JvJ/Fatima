...
public class WorldTest {
	...
	public static String _scenarioFolder = "";
	...
	static public void main(String args[]) throws Exception{
		...
		if (args.length == 3){
			_scenarioFolder = args[0];
			
			args = loadArgumentsFromScenarioDefinition(_scenarioFolder + args[1], args[2]);
	...
	public WorldTest(int port, String scenery, String actionsFile, String agentLanguageFile, String userLanguageFile, String userOptionsFile, boolean simplifiedVersion, ArrayList<String> objects) throws IOException {
		...
		{
			_objects.add(sObject.ParseFile(_scenarioFolder,objName));
		}

		try{
			
			if(agentLanguageFile != null){
				_agentLanguage = this.initializeLanguageEngine("name", "victim", "M",_scenarioFolder +  agentLanguageFile);
			}
	
			
			_userInterface.WriteLine("Finished Language Engine initialization!");
			
			LoadOperators(actionsFile);
	...
	private void LoadOperators(String xmlFile) throws Exception 
	{
		...
		SAXparser.parse(new File(_scenarioFolder + xmlFile + ".xml"), op);	
