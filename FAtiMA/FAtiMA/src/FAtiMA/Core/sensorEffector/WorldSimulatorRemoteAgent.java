...
public class WorldSimulatorRemoteAgent extends RemoteAgent {
	...
	public void ReportInternalPropertyChange(String agentName, Name property, Object value) {
		...
		if(entity.equals(Constants.SELF_STRING))
		{
			entity = agentName;
		}
	...
	protected void PropertyChangedPerception(Boolean persistent, String perc)
	{
		...
		if( st.countTokens() == 4 ){
			...
			pp = new PropertyPerception(persistent, null, ToM, propertyName, value);
...
/*
	...
	protected void ActionFailedPerception(String perc) {
		...
		if(subject.equals(_agent.getName()))
		{
			...
			event.SetSubject(Constants.SELF_STRING);
