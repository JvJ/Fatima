...
public class ActionLibrary implements Serializable {
	 ...
	 */
	public void checkIntegrity(AgentModel am, IntegrityValidator val) throws UnspecifiedVariableException, UnknownSpeechActException {
	    ListIterator<Step> li = _actions.listIterator();
	    
	    while(li.hasNext()) {
	         li.next().CheckIntegrity(am, val);
	    }
	}
