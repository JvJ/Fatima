...
public class EmotionalEventCondition extends EmotionCondition {
	...
	public static EmotionalEventCondition ParseEmotionalEventCondition(Attributes attributes) throws InvalidEmotionTypeException {
		...
		if(aux != null)
		{
			eec = new EmotionalEventCondition(active,emotionType,intensity,subject,action,target,parameters,aux);
		}
		else 
		{
	...
	public EmotionalEventCondition(boolean active, String emotion, Symbol intensity, Symbol subject, Symbol action, Symbol target, ArrayList<Symbol> parameters, String ToM)
	{
		super(active,emotion,ToM);
