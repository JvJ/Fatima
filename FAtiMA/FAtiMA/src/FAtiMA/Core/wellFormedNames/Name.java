...
public abstract class Name implements IGroundable, Cloneable, Serializable {
	...
	{
		if(name.equals(Constants.SELF_STRING))
		{
			return agentName;
		}
		else
	...
	public abstract ArrayList<Symbol> getVariableList();
	
	public abstract void applyPerspective(String name);
	
	public abstract void removePerspective(String name);
