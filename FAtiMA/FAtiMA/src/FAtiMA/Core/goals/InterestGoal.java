...
public class InterestGoal extends Goal {
	 ...
	 * 									  effects
	 */
	public void checkIntegrity(AgentModel am, IntegrityValidator val) throws UnreachableGoalException {
	    val.findUnreachableConditions(am, _name.toString(),_protectionConstraints);
	}
