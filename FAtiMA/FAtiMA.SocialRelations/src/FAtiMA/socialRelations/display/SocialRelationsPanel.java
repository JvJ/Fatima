...
public class SocialRelationsPanel extends AgentDisplayPanel {
	...
	public boolean Update(AgentModel am)
	{
		...
		relations.addAll(LikeRelation.getAllRelations(am.getMemory(),Constants.SELF_STRING));
		relations.addAll(RespectRelation.getAllRelations(am.getMemory(), Constants.SELF_STRING)); 
